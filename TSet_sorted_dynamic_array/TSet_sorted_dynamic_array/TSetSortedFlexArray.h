 ...
 *  \author Petyovský
 *  \version 2025
 *  $Id: TSetSortedFlexArray.h 3085 2025-04-17 18:24:24Z petyovsky $
 */
 ...
 */
[[nodiscard]] int set_flex_array_search(const struct TSetSortedFlexArray *aFlexArray, TSetElement aValue, size_t *aPosPtr, size_t aSize);
 ...
 */
[[nodiscard]] bool set_flex_array_insert(struct TSetSortedFlexArray **aFlexArrayPtr, TSetElement aValue, size_t aSize);
 ...
 */
[[nodiscard]] bool set_flex_array_erase(struct TSetSortedFlexArray **aFlexArrayPtr, TSetElement aValue, size_t aSize);
 ...
 */
[[nodiscard]] size_t set_flex_array_begin_pos(const struct TSetSortedFlexArray *aFlexArray);
 ...
 */
[[nodiscard]] bool set_flex_array_is_valid_pos(const struct TSetSortedFlexArray *aFlexArray, size_t aPos, size_t aSize);
 ...
 */
[[nodiscard]] size_t set_flex_array_next_pos(const struct TSetSortedFlexArray *aFlexArray, size_t aPos);
 ...
 *  \attention Funkce ověřuje platnost ukazatele a parametru \p aSize \b pouze při překladu v režimu `Debug`, kdy pomocí `assert` hlásí běhovou chybu!
 */
[[nodiscard]] TSetElement set_flex_array_value_at_pos(const struct TSetSortedFlexArray *aFlexArray, size_t aPos);
