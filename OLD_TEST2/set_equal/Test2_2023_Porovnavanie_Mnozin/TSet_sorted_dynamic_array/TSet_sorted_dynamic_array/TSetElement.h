 ...
 *  \author Petyovský
 *  \version 2025
 *  $Id: TSetElement.h 3085 2025-04-17 18:24:24Z petyovsky $
 */
...
struct TString
{
	char iStr[21];					///< Jméno studenta (20 znaků + 1 ukončovací znak '\0')						///< Bodové hodnocení studenta
};

typedef struct TString TSetElement;
		



///< Definice typu SetElement
#define TSET_ELEMENT_FRMSTR "%21s"		///< Definice formátovacího řetězce pro souborové operace s typem SetElement
