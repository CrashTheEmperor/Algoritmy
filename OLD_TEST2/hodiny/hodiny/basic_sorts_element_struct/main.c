...
int main(int argc, char *argv[])
	...
	//FILE *fsrc = fopen("sorted_ascend_data_time.txt", "r");
	//FILE *fsrc = fopen("sorted_descend_data_time.txt", "r");
	...
	/*("Insert Sort", insert_sort, &vector_orig);
...
/*
	...
	insert_sort(&vector_orig);
	vector_element_set_comparator(EbyHour);
	insert_sort(&vector_orig);
