 ...
 *  \author Petyovský
 *  \version 2025
 *  $Id: ut_adapter_vs.h 3014 2025-03-19 16:53:40Z petyovsky $
 */
...
#define UT_METHOD(aMethodName) \
	static_assert(#aMethodName [0] == 't' && \
				  #aMethodName [1] == 'e' && \
				  #aMethodName [2] == 's' && \
				  #aMethodName [3] == 't', \
				  "The method name must have the prefix: `test`, for example: `testSomething`"); \
